import {Latex, LatexDefaultDisplay, LatexDefaultInline, LatexDisplay, Panel, Section, Todo} from "bluelib";
                ...
                <div>
                    ...
                    <Section title="Vettori">
                        ...
                        <Panel title="Prodotto vettoriale">
                            ...
                            <ul>
                                ...
                                <li><a href="https://it.wikipedia.org/wiki/Regola_della_mano_destra">Regola della mano
                                    destra</a></li>
                            </ul>
                            <p>
                                Non è commutativo!
                    ...
                    <Section title="Elettrostatica">
                        ...
                        <Panel title="Conduttori e isolanti">
                            <p>
                                Più <a href="https://it.wikipedia.org/wiki/Ione">ioni</a> ha un corpo, meglio la carica
                    ...
                    <Section title="Forze magnetiche">
                        ...
                        <Panel title="Forza magnetica in un filo">
                            ...
                            <p>
                                <Latex>{r`\vec{F}_{magnetica} = I \cdot (\vec{L} \times \vec{B})`}</Latex> <a
                                href="https://it.openprof.com/wb/forza_di_lorentz_su_un_filo_percorso_da_corrente?ch=360">[1]</a>
                            </p>
                            <p>
                    ...
                    <Section title="Campi magnetici">
                        ...
                        <Panel title="Legge di Oersted">
                            <p>
                                <i>Caso particolare della <a href="https://it.wikipedia.org/wiki/Legge_di_Amp%C3%A8re">Legge
                                    di Ampère</a>.</i>
                            </p>
                            <p>
                    ...
                    <Section>
                        <Panel title="Legge di Faraday-Neumann-Lenz">
                            ...
                            <p>
                                Il meno è dovuto alla <a href="https://it.wikipedia.org/wiki/Legge_di_Lenz">Legge di
                                Lenz</a>, che specifica qualitativamente il verso della forza elettromotrice indotta.
                            </p>
                        </Panel>
                    ...
                    <Section title="Spettroscopia">
                        <Panel title="Emissione">
                            <p>
                                I solidi, se portati ad alta temperatura, emettono luce con uno <a
                                href="https://it.wikipedia.org/wiki/Spettro_continuo">spettro continuo</a>.
                            </p>
                            <p>
